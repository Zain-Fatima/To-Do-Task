...
function showAllTasks() {
    let allTasks = document.querySelectorAll('.taskmain');
    allTasks.forEach(task => {
        task.classList.remove('visibility');
    });
}

document.querySelector('.todaytasks').addEventListener('click', showAllTasks);
...
document.getElementById('highpriority').addEventListener('click', function () {
    ...
    midLevelTasks.forEach(midLevels => {
        ...
        parentTask.classList.add('visibility');
    });
...
document.querySelector('.todaytasks').addEventListener('click', function () {
    let allTasks = document.querySelectorAll('.taskmain');
    allTasks.forEach(task => {
        task.classList.remove('visibility');
    });
